            ...
            <div>
              {!content.video_link&& (
                <>
                  ...
                  >
                    <Image
                      src={content?.image? `${IMAGEURL}${content?.image}`:"/all/no-img.avif"}
              ...
              {content?.video_link && (
                ...
                <div  className="media-img event__thumb">
                  <Image
                    src={content?.image?`${IMAGEURL}${content?.image}`:"/all/no-img.avif"} className="img-fluid"
        ...
        <div className="lightbox">
          <div className="lightbox-content">
            {!currentContent.video_link && (
              <>
                <Image
                  src={currentContent?.image?`${IMAGEURL}${currentContent?.image}`:"/all/no-img.avif"}
                  alt="Content Thumbnail"
                  width={800}
                  height={500}
